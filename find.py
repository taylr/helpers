...
if __name__ == "__main__":
    ...
    parser.add_argument('-x', '--exclude',   help='egrep exclude regex',               default='\.git|site-pack|\.pyc|_generated|\.png|\.jpg|fixture|migration|js-coverage|node_modules|bower_components|vendor\/|\/dist\/|\.min\.|plato-reports|\.coverage|workspace\.xml|coverage\.xml|junit\.xml|\.ipynb|\/bin\/|test.*\.xml|\/tmp\/|\.json')
